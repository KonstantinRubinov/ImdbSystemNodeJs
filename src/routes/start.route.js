...
router.route("/main-es5.78c2944075552d9f1a0e.js").get(startController.GetMain1);
router.route("/main-es2015.78c2944075552d9f1a0e.js").get(startController.GetMain2);
